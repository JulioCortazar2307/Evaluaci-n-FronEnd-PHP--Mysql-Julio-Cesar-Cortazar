...
<body onload="document.getElementById('phone').focus()">
    <!-- Spinner Start -->
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top py-0 pe-5">
        ...
        <img src="img/images.png" width="90" height="100">
        </a>
                    ...
                    <div class="col-12 col-md-6 col-lg-6">
                        <div class="col-12 col-md-9">
                            <div class="form-outline mb-4">
                                <div class="mb-4">
                                    <div class="form-outline mb-4">
                                        <label for="cargo" class="nav-link"> &nbsp;<strong>NUMERO DE TELEFONO </strong></label>
                                            <input type="text" id="phone" class="form-control Input" name="phone" maxlength="11" required>
                                    </div>
                                </div>
                            </div>
                        </div>
